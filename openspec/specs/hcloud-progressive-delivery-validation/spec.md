## Purpose
Validate Argo Rollouts behavior on the ephemeral hcloud lab cluster without changing cloud infrastructure lifecycle or destabilizing the ArgoCD-managed demo path.
