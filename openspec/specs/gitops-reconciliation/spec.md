# gitops-reconciliation Specification

## Purpose

Define the disposable local ArgoCD reconciliation exercise for the delivery lab. This capability keeps GitOps reconciliation outside the default Garden validation loop while proving app-of-apps ordering, raw-Kustomize-safe sources, sync/health behavior, and demo drift self-heal in a local kind cluster.
