# rollout-risk-review-workflow Specification

## Purpose

Define a read-only pre-rollout risk review workflow that consumes release intent and optional health-gate evidence to report blockers, risks, unknowns, and readiness without mutating Git, clusters, ArgoCD, Rollouts, Terraform, or hcloud resources.
