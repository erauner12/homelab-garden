...
- The parent Application manages two children: `platform-local` for `platform/overlays/local` and `demo-api-local` for `apps/demo-api/overlays/local`.
